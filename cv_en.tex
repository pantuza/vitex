...
& \footnotesize{I work at a Free Software project called Network API.
    ...
    We developed a cloud solution inside Netowork API through OpenDaylight,
    ...
    products contents and control its life cycle.} \\
\multicolumn{2}{c}{} \\
...
& \footnotesize{As a researcher by the Nacional Center of Research in Brazil
    ...
    Working inside WiNET, I've written a IP Load Balancer through Pox SDN
    Controller and evaluate the openflow protocol impact on scenarios like
    burst and constant requests on a Web Server. Also, add a Graph module to
