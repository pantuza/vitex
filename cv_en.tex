...
\textsc{Research:} & \href{https://scholar.google.com/citations?user=V6xqvdgAAAAJ}{Google Scholar Profile} \\
...
\textsc{Jan 2025 - Current} & \emph{\bf Computer Science PhD Candidate at UFMG}, \\
& \footnotesize{
  I am a PhD candidate at the Federal University of Minas Gerais (UFMG) in the
  Computer Science department. My research is focused on the intersection of
  Distributed Systems and Observability. I am working on a project that aims to
  improve applications resilience by observing networks profile data at scale.
  } \\
\multicolumn{2}{c}{} \\
...
\textsc{Jul 2023 - Current} & \emph{\bf Computer Science consultant}, \\
& \footnotesize{
  I am running trainings and consulting services for companies and developers
  in the area of Observability, Distributed Systems and Cloud Computing. It helpes
  companies to embrace and get a smooth transition to technologies such as Open Telemetry,
